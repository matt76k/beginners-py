...
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_design', 'sphinx_book_theme', 'sphinx_proof', 'sphinx.ext.imgmath', 'sphinx_jupyterbook_latex', 'sphinx_multitoc_numbering']
...
html_title = '異世界転生！Python魔法を極めて無双した件 〜チートスキルゼロ！データの深淵を覗き、数値の混沌を操り、隠された真実を解き明かす存在へ〜'
